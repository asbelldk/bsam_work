...
BEGIN_MESSAGE_MAP(CWin2Dlg, CDialog)
	ON_WM_PAINT()
	ON_WM_CREATE()
	ON_BN_CLICKED(IDC_BUT_SAVE_BMP,		&CWin2Dlg::OnBnClickedButSaveBmp)
	ON_BN_CLICKED(IDC_BUT_TAKE_PICTURE, &CWin2Dlg::OnBnClickedButTakePicture)
	ON_BN_CLICKED(IDC_CHECK_GRAY,		&CWin2Dlg::OnBnClickedCheckGray)
	ON_BN_CLICKED(IDC_BUT_LEFT_RIGHT,   &CWin2Dlg::OnBnClickedButLeftRight)
END_MESSAGE_MAP()
...
void CWin2Dlg::OnBnClickedButSaveBmp()
{
...
int CWin2Dlg::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
